...
from commishdesk.render.discord import _escape_discord_markdown
...
# --------------------------------------------------------------------------- #
# Story 5.11a — _escape_discord_markdown (the weekly post itself is covered in
# tests/test_render_weekly_discord.py, Story 5.14b)
# --------------------------------------------------------------------------- #
